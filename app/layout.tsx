...
import { KbarRoot } from "@/presentation/features/kbar.feature";
...
const headerItems = [
  ...
  { id: 'discover', label: 'Discover', children: [
    { id: 'feed', label: 'Feed', href: '/discover/feed', description: 'Engineering blogs & articles' },
    { id: 'yc', label: 'YC Companies', href: '/discover/yc', description: 'Browse Y Combinator startups' },
    { id: 'ph', label: 'Product Hunt', href: '/discover/ph', description: 'Latest product launches' },
    { id: 'knowledge', label: 'Knowledge Graph', href: '/discover/knowledge', description: 'Interconnected engineering concepts' },
    ...
    { id: 'npm', label: 'NPM', href: '/discover/npm', description: 'Search packages' },
    { id: 'devto', label: 'Dev.to', href: '/discover/devto', description: 'Developer articles' },
    { id: 'medium', label: 'Medium', href: '/discover/medium', description: 'Tech publications' },
    { id: 'reddit', label: 'Reddit', href: '/discover/reddit', description: 'Programming discussions' },
  ]},
