...
function loadLessonMarkdown(hubSlug: string, lessonSlug: string): string | null {
  const filePath = path.resolve(
    process.cwd(),
    'public', 'knowledge-cache', 'case-studies', hubSlug, `${lessonSlug}.md`
  );
  try {
    ...
    <div className="min-h-screen bg-white">
      <div className="border-b border-border bg-surface-secondary">
        <div className="max-w-[900px] mx-auto px-6 py-3 flex items-center justify-between">
          <Link
            href={`/knowledge/case-studies/${slug}`}
      ...
      <div className="max-w-[900px] mx-auto px-6 lg:px-12 py-12">
        ...
        <div className="mt-16 pt-8 border-t border-border flex items-center justify-between">
          {prevLesson ? (
            <Link href={`/knowledge/case-studies/${slug}/${prevLesson.slug}`} className="group flex items-center gap-2 text-sm font-semibold text-accent hover:text-accent/80 transition-colors">
          ...
          {nextLesson ? (
            <Link href={`/knowledge/case-studies/${slug}/${nextLesson.slug}`} className="group flex items-center gap-2 text-sm font-semibold text-accent hover:text-accent/80 transition-colors text-right">
              <div>
            ...
            <Link href={`/knowledge/case-studies/${slug}`} className="flex items-center gap-2 text-sm font-semibold text-accent hover:text-accent/80 transition-colors">
