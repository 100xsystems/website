...
export default async function PrincipleLessonPage({ params }: Props) {
  ...
  const raw = loadLessonMarkdown('principles', slug, lessonSlug);
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-border bg-surface-secondary">
        <div className="max-w-[900px] mx-auto px-6 py-3 flex items-center justify-between">
          <Link
            href={`/knowledge/principles/${slug}`}
      ...
      <div className="max-w-[900px] mx-auto px-6 lg:px-12 py-12">
        ...
        <div className="mt-16 pt-8 border-t border-border flex items-center justify-between">
          {prevLesson ? (
            <Link
              href={`/knowledge/principles/${slug}/${prevLesson.slug}`}
          ...
          {nextLesson ? (
            <Link
              href={`/knowledge/principles/${slug}/${nextLesson.slug}`}
