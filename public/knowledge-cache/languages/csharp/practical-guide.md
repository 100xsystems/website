...
learning_objectives:
  ...
  - "Use package management (NuGet (via dotnet CLI)) effectively"
  - "Work with ASP.NET Core for real projects"
...
| Package Manager | Dependency management | NuGet (via dotnet CLI) |
| Linter | Code quality | csharp linter |
| Formatter | Consistent style | csharp formatter |

## Package Management with NuGet (via dotnet CLI)
...
```csharp
# Example: basic setup with ASP.NET Core
...
- **Entity Framework** — For specialized use cases
- **Blazor** — Extends functionality
...
> **Prompt 1 (Architecture Review):** "I'm building a production C# service using ASP.NET Core. What architectural patterns should I follow? Consider error handling, logging, testing, and deployment as separate dimensions. Give me a checklist."

> **Prompt 2 (Ecosystem Deep Dive):** "Compare ASP.NET Core with Entity Framework in the C# ecosystem. When should I choose one over the other? Give me decision criteria with tradeoffs."
...
- Use NuGet (via dotnet CLI) for dependency management
- ASP.NET Core is the go-to framework for most projects
...
- [C# Production Best Practices](https://docs.csharp.org/)
- [C# Style Guide](https://github.com/topics/csharp-styleguide)
- [Open Source C# Projects](https://github.com/topics/csharp)
