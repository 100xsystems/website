...
const navigationActions: KbarAction[] = createSectionActions('Navigation', [
  ...
  { id: 'feed', name: 'Engineering Feed', shortcut: ['f'], keywords: 'feed engineering articles blogs discovery', href: '/feed' },
  ...
  { id: 'tools', name: 'Tools', keywords: 'developer tools utilities', href: '/tools' },
  { id: 'technologies', name: 'Technologies', keywords: 'technologies platforms frameworks', href: '/technologies' },
  { id: 'awesome', name: 'Awesome Lists', keywords: 'awesome github curated resources lists', href: '/discover/awesome' },
  { id: 'feed-bookmarks', name: 'Feed Bookmarks', keywords: 'bookmarks saved articles feed', href: '/feed/bookmarks' },
  { id: 'languages', name: 'Programming Languages', keywords: 'languages programming coding', href: '/languages' },
  { id: 'discover', name: 'Discover', keywords: 'discover explore', href: '/discover' },
  { id: 'activity', name: 'Activity', keywords: 'activity verify recent', href: '/activity' },
  { id: 'settings', name: 'Settings', shortcut: ['g', 'i'], keywords: 'settings preferences config', href: '/settings' },
  { id: 'portfolio', name: 'Portfolio', keywords: 'portfolio profile', href: '/portfolio' },
  { id: 'cli-docs', name: 'CLI Documentation', keywords: 'cli command line docs documentation', href: '/cli-docs' },
